...
public class DistributorController {
    ...
    private final DistributorCreateUseCase distributorCreateUseCase;
    private final DistributorUpdateUseCase distributorUpdateUseCase;
    private final DistributorFindByIdUseCase distributorFindByIdUseCase;
    private final DistributorFindByUserIdUseCase distributorFindByUserIdUseCase;
    private final DistributorsFindUseCase distributorsFindUseCase;
    private final DistributorEnableUseCase distributorEnableUseCase;
    private final DistributorDisableUseCase distributorDisableUseCase;
    private final CommissionBalanceUpdateUseCase commissionBalanceUpdateUseCase;
    private final TotalCommissionUpdateUseCase totalCommissionUpdateUseCase;
    private final ExistsByPhoneUseCase existsByPhoneUseCase;
    private final ExistsByUserIdUseCase existsByUserIdUseCase;
    private final ExistsByIdCardUseCase existsByIdCardUseCase;
    ...
    public Result<Long> createDistributor(@Valid @RequestBody CreateDistributorRequest request) {
        ...
        Long distributorId = distributorCreateUseCase.createDistributor(command);
        return Result.success("分销商创建成功",distributorId);
    }
    ...
    public Result<Void> updateDistributor(
        ...
        distributorUpdateUseCase.updateDistributor(command);
    ...
    public Result<Distributor> getDistributor(
        ...
        Distributor distributor = distributorFindByIdUseCase.findById(distributorId);
    ...
    public Result<Distributor> getDistributorByUserId(
        ...
        Distributor distributor = distributorFindByUserIdUseCase.findByUserId(userId);
        return Result.success(distributor);
    }
    ...
    public Result<List<Distributor>> getDistributors(
        ...
        List<Distributor> distributors = distributorsFindUseCase.findDistributors(query);
    ...
    public Result<Void> enableDistributor(
        ...
        distributorEnableUseCase.enableDistributor(distributorId, "system");
        return Result.success();
    }
    ...
    public Result<Void> disableDistributor(
        ...
        distributorDisableUseCase.disableDistributor(distributorId, "system");
        return Result.success();
    }
    ...
    public Result<Void> updateCommissionBalance(
        ...
        commissionBalanceUpdateUseCase.updateCommissionBalance(distributorId, amount, "system");
        return Result.success();
    }
    ...
    public Result<Void> updateTotalCommission(
        ...
        totalCommissionUpdateUseCase.updateTotalCommission(distributorId, amount, "system");
        return Result.success();
    }
    ...
    public Result<Boolean> existsByUserId(
        ...
        boolean exists = existsByUserIdUseCase.existsByUserId(userId);
    ...
    public Result<Boolean> existsByPhone(
        ...
        boolean exists = existsByPhoneUseCase.existsByPhone(phone);
        return Result.success(exists);
    }
    ...
    public Result<Boolean> existsByIdCard(
        ...
        boolean exists = existsByIdCardUseCase.existsByIdCard(idCard);
        return Result.success(exists);
    }
}

...
public interface DistributorRepository {
    ...
    List<Distributor> findByQuery(DistributorQuery query);

    boolean existsByUserId(Long userId);

    boolean existsByPhone(String phone);

    boolean existsByPhoneAndIdNot(String phone, Long distributorId);

    boolean existsByIdCard(String idCard);

    boolean existsByIdCardAndIdNot(String idCard, Long distributorId);
